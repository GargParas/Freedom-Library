...
Connection con;
    ...
    public MEMBER_INFO() {
        ...
        try
        {
            ...
            rs=st.executeQuery("Select * from addmember");
            int i=1;
            while(i<=rs.getMetaData().getColumnCount())
            {
                t.addColumn(rs.getMetaData().getColumnName(i));
                i++;
            }
            while(rs.next())
            {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Member id", "Name", "Class", "Stream", "Session", "Contact", "Admission no"
            }
        ));
