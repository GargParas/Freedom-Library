...
public class ISSUE_BOOK extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Member detail"));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Book detail"));
        ...
        jComboBox7.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2020", "2021", "2022", "2023", "2024", " " }));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       try
       {
            ...
            rs = st.executeQuery("select * from addmember where member_id = "+"'"+mid+"'");
            rs.next();
       ...
       {
       e.printStackTrace();
       JOptionPane.showMessageDialog(this, "Sorry! Member does not Exist");
       } 
    ...
    int adm_no = Integer.parseInt(jTextField8.getText());
    String title = jTextField2.getText();
    String author = jTextField4.getText();
    String name = jTextField6.getText();
    String CLASS = (String)jComboBox1.getSelectedItem();
    String isd = (String)jComboBox2.getSelectedItem();
    String ism = (String)jComboBox3.getSelectedItem();
    String isy = (String)jComboBox4.getSelectedItem();
    String dateissue=isy+"/"+ism+"/"+isd;
    String rtd = (String)jComboBox5.getSelectedItem();
    String rtm = (String)jComboBox6.getSelectedItem();
    String rty = (String)jComboBox7.getSelectedItem();
    String datereturn=rty+"/"+rtm+"/"+rtd;
     ...
     try
        {
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/lib","root","PARAM");
            st=con.createStatement();
            st.execute("delete from book_info where ACC_NO ="+"'"+acc+"'");
            st.execute("insert into issue values("+"'"+mid+"'"+ ","+"'"+name+"'"+ ","+"'"+CLASS+"'"+ ","+"'"+adm_no+"'"+ ","+"'"+acc+"'"+ ","+"'"+title+"'"+ ","+"'"+price+"'"+","+"'"+author+"'"+","+"'"+dateissue+"'"+","+"'"+datereturn+"'"+ ")");
            JOptionPane.showMessageDialog(this,"YOUR BOOK IS ISSUED");
        }
     catch(Exception e) 
       {
       e.printStackTrace();
