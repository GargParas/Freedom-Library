...
public class RETURN_BOOK extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try
        {
            ...
            rs = st.executeQuery("select * from issue where acc_no = "+"'"+acc+"'");
            rs.next();
...
//            System.out.println(acc);
            int mid = Integer.parseInt(jTextField5.getText());
            Class.forName("java.sql.DriverManager");
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/lib","root","PARAM");
            st=con.createStatement();
            rs = st.executeQuery("select * from addbook where acc_no = "+"'"+acc+"'");
            rs.next();
            st.execute("insert into book_info values ("+"'"+acc+"'"+","+"'"+rs.getString(2)+"'"+","+"'"+rs.getString(3)+"'"+","+"'"+rs.getString(4)+"'"+","+"'"+rs.getString(5)+"'"+","+"'"+rs.getString(6)+"'"+","+"'"+rs.getString(7)+"'"+ ")");
            st.execute("delete from issue where acc_no ="+"'"+acc+"'"+"and member_id ="+"'"+mid+"'");
            JOptionPane.showMessageDialog(this,"YOUR BOOK IS RETURNED");
        }
        catch(Exception e)
        {
          e.printStackTrace();
